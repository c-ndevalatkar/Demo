 ...
 */
@Entity
@Table(name = "mdm_dimension")
public class MdmDimension {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "mdm_dimension_id_seq")
	@SequenceGenerator(name = "mdm_dimension_id_seq", sequenceName = "mdm_dimension_id_seq", allocationSize = 1)
	// @Id
